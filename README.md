...
This project demonstrates a comprehensive data warehousing and analytics solution, from building a data warehouse to generating actionable insights by creating customer and product related reports
...
│   ├── etl                             # file that shows all different techniquies and methods of ETL
│   ├── data_architecture               # file that shows the project's architecture
